      ...
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-5 sm:px-8">
        ...
        {user && profile ? (
          <div className="flex items-center gap-2">
            <Link
              href="/submit"
              className="rounded-full bg-gradient-to-r from-[#7c3aed] to-[#6d28d9] px-4 py-1.5 text-[13px] font-medium text-white shadow-lg shadow-purple-500/20 transition-all hover:shadow-purple-500/30 hover:brightness-110"
            >
              Submit App
            </Link>
            <UserMenu
